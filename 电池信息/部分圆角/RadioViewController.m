...
- (void)viewDidLoad {
    ...
    [ViewRadioTool ViewRadioWith:viewnew RadioViewWithBouns:viewnew.bounds radio:30.0 RectCornerType:UIRectCornerTopLeft|UIRectCornerTopRight|UIRectCornerBottomRight];
...
//    [openset buttonGradient:@[[UIColor colorWithHexString:@"FED101"],[UIColor colorWithHexString:@"FCAD00"]] buttonCGSize:CGSizeMake(__kWidth-20 ,44 ) ByGradientType:TXJDirectionTypeLeft2Right cornerRadius:YES];
    [ViewRadioTool ViewRadioWith:openset RadioViewWithBouns:openset.bounds radio:30.0 RectCornerType:UIRectCornerTopRight|UIRectCornerTopLeft];
